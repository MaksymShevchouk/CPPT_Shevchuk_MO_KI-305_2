 ...
 */
public class Lamp {
    private Type TypeOfLamp;
    private Light LightOfLamp;
     ...
     * Constructor
     * 
     * @param <code>resource</code> Lamp resource
     * @throws FileNotFoundException
     */
    public Lamp(int resource) throws FileNotFoundException {
        TypeOfLamp = new Type();
        LightOfLamp = new Light();
    ...
    /**
     * Method provides information about the lamp
     */
